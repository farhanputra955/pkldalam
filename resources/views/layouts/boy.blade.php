...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/bootstrap/dist/css/bootstrap.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/fontawesome-free/css/all.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/icon-kit/dist/css/iconkit.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/ionicons/dist/css/ionicons.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/perfect-scrollbar/css/perfect-scrollbar.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/datatables.net-bs4/css/dataTables.bootstrap4.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/jvectormap/jquery-jvectormap.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/weather-icons/css/weather-icons.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/c3/c3.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/owl.carousel/dist/assets/owl.carousel.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/plugins/owl.carousel/dist/assets/owl.theme.default.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/boy/dist/css/theme.min.css')}}">
    ...
    <body>
                ...
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="index.html">
                            <div class="logo-img">
                               <img src="{{asset('assets/boy/src/img/brand-white.svg')}}" class="header-brand-img" alt="lavalite"> 
                            </div>
        ...
        <script src="{{asset('assets/boy/https://code.jquery.com/jquery-3.3.1.min.js')}}"></script>
        <script>window.jQuery || document.write('<script src="{{asset('assets/boy/src/js/vendor/jquery-3.3.1.min.js')}}"><\/script>')</script>
        <script src="{{asset('assets/boy/plugins/popper.js/dist/umd/popper.min.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/bootstrap/dist/js/bootstrap.min.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/perfect-scrollbar/dist/perfect-scrollbar.min.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/screenfull/dist/screenfull.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/datatables.net/js/jquery.dataTables.min.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/datatables.net-bs4/js/dataTables.bootstrap4.min.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/datatables.net-responsive/js/dataTables.responsive.min.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/jvectormap/jquery-jvectormap.min.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/jvectormap/tests/assets/jquery-jvectormap-world-mill-en.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/moment/moment.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/d3/dist/d3.min.js')}}"></script>
        <script src="{{asset('assets/boy/plugins/c3/c3.min.js')}}"></script>
        <script src="{{asset('assets/boy/js/tables.js')}}"></script>
        <script src="{{asset('assets/boy/js/widgets.js')}}"></script>
        <script src="{{asset('assets/boy/js/charts.js')}}"></script>
        <script src="{{asset('assets/boy/dist/js/theme.min.js')}}"></script>
